...
Command: npx gltfjsx@6.5.3 PLANTA_03.3.gltf 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF("/gltf/Planta/PLANTA_03.3.gltf");
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-1.375, 0, 3.911]} scale={0.002}>
        ...
        <group position={[-926.379, -685.412, 2388.681]} scale={75}>
          <group rotation={[-Math.PI / 2, 0, 0]}>
            <mesh
              castShadow
              geometry={nodes.Leaf.geometry}
              material={materials["Ficus Elastica 2 Leaf"]}
              position={[0, 0, 7.392]}
            />
          </group>
        </group>
...
useGLTF.preload("/PLANTA_03.3.gltf");
