...
Command: npx gltfjsx@6.5.2 ON — NIKITA + MATTHIEU .gltf 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF("/src/lights/Pole/nikita_matthieu.gltf");
  return (
    <group {...props} dispose={null}>
      <group scale={0.001}>
        ...
        <group
          position={[2074.906, -16.665, -1096.196]}
      ...
      <PerspectiveCamera
        ...
        near={8611.031}
        fov={26.991}
        position={[12.507, 4.558, 3.77]}
        rotation={[-0.264, 1.095, 0.236]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={0.001}
        fov={26.991}
        position={[-1.425, 2.055, 1.266]}
        rotation={[0.173, -0.842, 0.13]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={0.001}
        fov={26.991}
        position={[1.5, 1.637, 0.495]}
        rotation={[0.957, 1.054, -0.89]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={3641.259}
        fov={26.991}
        position={[-4.418, 1.742, 3.975]}
        rotation={[-0.097, -0.838, -0.072]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={460.477}
        fov={26.991}
        position={[-0.033, 0.915, 2.331]}
        rotation={[0.605, -0.012, 0.008]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={0.001}
        fov={26.991}
        position={[-0.01, 1.914, 0.66]}
        rotation={[0.543, -0.52, 0.291]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
      ...
      <PerspectiveCamera
        ...
        near={21.577}
        fov={26.991}
        position={[-1.637, 1.6, 1.971]}
        rotation={[0.373, -0.658, 0.235]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={3737.526}
        fov={26.991}
        position={[0.006, 1.045, 4.903]}
        rotation={[0.051, -0.007, 0]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={3877.296}
        fov={26.991}
        position={[-3.909, 1.281, 4.5]}
        rotation={[0.017, -0.717, 0.011]}
        scale={0.001}
      />
      <OrthographicCamera
        makeDefault={false}
        far={7189.515}
        near={0.001}
        position={[-1.199, 4.064, 1.079]}
        rotation={[-0.298, -0.801, -0.217]}
        scale={0.001}
      />
      <OrthographicCamera
        makeDefault={false}
      ...
      <PerspectiveCamera
        ...
        near={14487.912}
        fov={26.991}
        position={[-7.514, 3.074, 14.647]}
        rotation={[-0.067, -0.508, -0.033]}
        scale={0.001}
      />
      <PerspectiveCamera
        makeDefault={false}
        ...
        near={2614.445}
        fov={73.74}
        position={[-4.229, 1.348, -4.273]}
        rotation={[2.98, -0.75, 3.031]}
        scale={0.001}
      />
    </group>
  );
...
useGLTF.preload("/nikita_matthieu.gltf");
